    ...
    <>
      {showIndicator ? (
        <div
          ...
          aria-live="polite"
        >
          <div className="rounded-full border border-zinc-200/80 bg-white/80 px-3 py-1.5 text-center text-[11px] font-medium text-zinc-600 shadow-sm backdrop-blur-sm dark:border-zinc-600/80 dark:bg-zinc-800/80 dark:text-zinc-300">
            {text}
          </div>
        </div>
      ) : null}
